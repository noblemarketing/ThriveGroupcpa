  ...
  return (
    <article className="flex h-full flex-col rounded-sm border border-black/10 bg-white p-6 shadow-sm transition hover:border-gold/40 hover:shadow-md">
      ...
      <Link
        ...
        className="mt-4 inline-flex min-h-[44px] min-w-[44px] items-center justify-start text-lg font-semibold text-black underline-offset-4 hover:text-gold hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold"
      >
